...
-->
@def title       = "Mecânica dos Sólidos"
@def prepath     = "Mecânica dos Sólidos"
@def description = """
                   Material para disciplinas de Mecânica dos Sólidos.
                   """
@def authors     = "Franco Jefferds dos S. Silva"
...
\newcommand{\reffig}[2]{~~~<a href='#1'>#2</a>~~~}

\newcommand{\beginfig}[1]{
~~~<div id=#1 style="text-align:center;"><span class="figcaption">~~~
}

\newcommand{\figure}[2]{
~~~
  <img src="!#1" style="padding:5px;#2">
~~~
}

\newcommand{\endfig}{~~~</span></div>~~~}

\newcommand{\figenv}[4]{
~~~
<div style='text-align: center;' id='#4'>
<figure>
  <figcaption class='fignumber'>#1</figcaption>
  <img src="!#2" style="padding:5px;#3" alt="#1">
</figure>
</div>
~~~
}